...
default_connection = connect(db='blood', host="mongodb+srv://praveen:praveen15a@praveenscluster.osa29pv.mongodb.net/?retryWrites=true&w=majority",tlsCAFile=certifi.where())
